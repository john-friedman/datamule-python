...
- Every [10-K](https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22Friedman%2C%20John%22&l=list&p=1&s=10&sort=bestmatch) from 2001 to September 2024. `10k_{year}` e.g. `10k_2002`. (Speed depends on Zenodo's servers. Switching to DropBox)
